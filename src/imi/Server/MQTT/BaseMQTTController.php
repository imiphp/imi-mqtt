...
abstract class BaseMQTTController
{
     ...
     */
    public abstract function publish(PublishRequestPacket $request, ReceiveData $receiveData);
     ...
     */
    public abstract function subscribe(SubscribeRequestPacket $request, ReceiveData $receiveData): ?SubscribeResponsePacket;
     ...
     */
    public abstract function unsubscribe(UnsubscribeRequestPacket $request, ReceiveData $receiveData): ?UnsubscribeResponsePacket;
